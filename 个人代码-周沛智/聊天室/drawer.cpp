    ...
    QToolBox(parent, f)
{
    ...
    toolBtn1->setIconSize(QPixmap(":/images/1.jpg").size());
    ...
    toolBtn2->setIconSize(QPixmap(":/images/2.jpg").size());
    ...
    toolBtn4->setIconSize(QPixmap(":/images/4.jpg").size());
    ...
    toolBtn7->setIconSize(QPixmap(":/images/7.jpg").size());
    ...
    toolBtn8->setIconSize(QPixmap(":/images/8.jpg").size());
    ...
    toolBtn9->setText("小美");
    toolBtn9->setIcon(QPixmap(":/images/9.jpg"));
    toolBtn9->setIconSize(QPixmap(":/images/9.jpg").size());
